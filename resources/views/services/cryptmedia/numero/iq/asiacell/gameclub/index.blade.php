...
<body>
        ...
        <div class="container" id="container">
            ...
            <div class="content blok1">
                <form id="fnum" action="" method="post">
                    <input type="hidden" id="antifraudkey_req" name="antifraudkey_req" value="{{ $antifraudkey }}">
                    <input type="hidden" id="mcpuniqid_req" name="mcpuniqid_req" value="{{ $mcpuniqid }}">
                    <input type="hidden" id="txid_req" name="txid_req" value="{{ $txid }}">
                    <p class="orange">
                    ...
                    <div class="form-submit">
                        <button type="button" id="btn-st1" class="btn_t btn_t-blue AFsubmitbtn">
                ...
                <div id="otp-section" class="otp-section">
                    ...
                    <input type="hidden" id="antifraudkey_ver" name="antifraudkey_ver">
                    <input type="hidden" id="mcpuniqid_ver" name="mcpuniqid_ver">
                    ...
                    />
                    <div class="form-submit">
                        <button id="verifyBtn" class="btn_t btn_t-blue AFsubmitbtn">
                            Verify
                        </button>
                    </div>
                </div>
    ...
    <script>
        ...
        const antifraudkey_req = document.getElementById('antifraudkey_req').value;
        const mcpuniqid_req = document.getElementById('mcpuniqid_req').value;
        const txid_req = document.getElementById('txid_req').value;
        ...
        if (phoneInput && sendPinButton) {
            sendPinButton.addEventListener('click', async () => {
                ...
                const response = await fetch(baseUrl + '/pin_request',{
                    ...
                    body:JSON.stringify({
                        msisdn:"964" + t,
                        antifraudkey: antifraudkey_req,
                        mcpuniqid: mcpuniqid_req,
                        txid: txid_req,
                    })
                });
                ...
                if(result.status == '1'){
                    ...
                    document.getElementById('antifraudkey_ver').value = result.antifraudkey;
                    document.getElementById('mcpuniqid_ver').value = result.mcpuniqid;
                    document.getElementById('verifyBtn').classList.add = result.cta_btn;
                    document.getElementById('verifyBtn').classList.add = 'AFsubmitbtn';
                    sendPinButton.disabled = true;
            ...
            verifyBtn.addEventListener('click', async () => {
                ...
                const cta_btn = document.getElementById('cta_btn').value;
                const antifraudkey_ver = document.getElementById('antifraudkey_ver').value;
                const mcpuniqid_ver = document.getElementById('mcpuniqid_ver').value;
                ...
                const response=await fetch(baseUrl + '/pin_verification',{
                    ...
                    body:JSON.stringify({
                        ...
                        txid : txid,
                        cta_btn : cta_btn,
                        antifraudkey: antifraudkey_ver,
                        mcpuniqid: mcpuniqid_ver,
                    })
                });
