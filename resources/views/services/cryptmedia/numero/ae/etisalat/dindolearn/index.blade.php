...
<head>
    ...
    <title>Dindolearn Subscription</title>
            ...
            <div class="header_new">
                ...
                <div class="hero">
                    <div class="hero-banner">
                        <img src="https://pt6.etisalat.ae/dcb-digital/assets/banner/Dindo/1632x544.jpg" alt="Dindo Learn banner">
                    </div>
                    <div class="hero-copy">
                        <p class="hero-title">
                            <span data-lang="en">Dindo Learn</span>
                        </p>
                        <p class="hero-subtitle">
                            <span data-lang="en">High Quality Unique Videos</span>
                        </p>
                    </div>
                </div>
            </div>
