...
<head>
    ...
    <title>Videowarrior Subscription</title>
    ...
    <div class="wrapper">
        <div class="container" id="container">
            <div class="header_new">
                <p class="price-strip">
                    <span data-lang="en">Free for 24 hours then AED 3.25/weekly (VAT Inclusive)</span>
                </p>

                <div class="hero">
                    <div class="hero-banner">
                        <img src="https://videowarrior.mobi/images/pics/logo.png" alt="Video Warrior banner">
                    </div>
                    <div class="hero-copy">
                        <p class="hero-title">
            ...
            <div class="content blok1">
                <form id="fnum" action="" method="post">
                    ...
                    <div class="phone-control" id="phone-control">
                        ...
                        <span style="color:#777;font-size: clamp(1.9rem, 4vw, 3.2rem);font-weight:700;">+971</span>
                        <input
                            type="tel"
                            inputmode="tel"
            ...
            <div class="terms" id="terms">
                ...
                <p data-lang="en">
                    ...
                    <br>• You will start the paid subscription after the free period automatically.
                    <br>• No commitment, you can cancel your subscription at any time by sending C GHW to 1111.
                    <br>• The free trial is valid only for new subscribers
                    <br>• Enjoy Your Free trial for 24 hours.
                    ...
                    <br>• By proceeding, you are accepting all Terms and Conditions of the service and agree to receive updates about your subscription on your registered mobile number.
                </p>
            </div>
        </div>
    </div>
    <script>
        ...
        if (phoneInput && sendPinButton) {
            sendPinButton.addEventListener('click', async () => {
                ...
                const valid = /^(0[0-9]{9}|[0-9]{9})$/.test(t);
